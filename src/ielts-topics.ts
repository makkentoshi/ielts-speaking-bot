...
export const QUESTIONS: Record<IeltsTopic, TopicQuestions> = {
  ...
  "Daily Routine": {
    part1: [
      ...
      "Do you prefer a fixed or flexible schedule?",
      "What do you do in your free time?",
      "How has your routine changed over time?",
    ],
    part2:
      "Describe a typical day in your life. You should say: what you do, who you spend time with, what you enjoy most, and why it is typical.",
    part3: [
      "How do people's daily routines differ across cultures?",
      "Is it better to have a busy or relaxed schedule?",
      "How does technology affect daily routines?",
    ],
  },
  Weather: {
    part1: [
  ...
  "Future Plans": {
    ...
    part2:
      "Describe a goal you want to achieve. You should say: what it is, why you want to achieve it, how you plan to do it, and what challenges you might face.",
    part3: [
      "Why is it important to set goals?",
      "How do people's ambitions change over time?",
      "Should young people plan their futures early?",
    ],
  },
  Hobbies: {
    part1: [
